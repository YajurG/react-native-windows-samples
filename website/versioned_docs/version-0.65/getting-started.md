---
id: version-0.65-getting-started
...
For information on the options that `react-native-windows-init` takes see [React Native Windows CLI](https://microsoft.github.io/react-native-windows/init-cli).
